...
class FieldMeasureApp:
    ...
    def __init__(self, root):
        ...
        # Initialize white color thresholds
        self.WHITE_COLOR_LOWER = np.array([0, 0, 200], np.uint8)
        self.WHITE_COLOR_UPPER = np.array([180, 50, 255], np.uint8)
        self.cap = None
    ...
    def create_widgets(self):
        ...
        Label(self.control_frame, text="Lower BGR:").grid(
        ...
        self.lower_b.set(self.WHITE_COLOR_LOWER[0])
        self.lower_b.grid(row=12, column=0, sticky="ew")
        self.lower_g = Scale(
            self.control_frame,
            from_=0,
            to=255,
        ...
        self.lower_g.set(self.WHITE_COLOR_LOWER[1])
        self.lower_g.grid(row=13, column=0, sticky="ew")
        self.lower_r = Scale(
            self.control_frame,
            from_=0,
            to=255,
        ...
        self.lower_r.set(self.WHITE_COLOR_LOWER[2])
        self.lower_r.grid(row=14, column=0, sticky="ew")
        ...
        self.upper_b.set(self.WHITE_COLOR_UPPER[0])
        self.upper_b.grid(row=12, column=1, sticky="ew")
        self.upper_g = Scale(
            self.control_frame,
            from_=0,
            to=255,
        ...
        self.upper_g.set(self.WHITE_COLOR_UPPER[1])
        self.upper_g.grid(row=13, column=1, sticky="ew")
        self.upper_r = Scale(
            self.control_frame,
            from_=0,
            to=255,
        ...
        self.upper_r.set(self.WHITE_COLOR_UPPER[2])
        self.upper_r.grid(row=14, column=1, sticky="ew")
    ...
    def update_thresholds(self, event=None):
        self.WHITE_COLOR_LOWER = np.array(
            [self.lower_b.get(), self.lower_g.get(), self.lower_r.get()], np.uint8
        )

        self.WHITE_COLOR_UPPER = np.array(
            [self.upper_b.get(), self.upper_g.get(), self.upper_r.get()], np.uint8
        )
