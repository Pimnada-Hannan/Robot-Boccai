...
class FieldMeasureApp:
    ...
    # เพิ่มใน __init__ หรือ reset_state_for_new_image_or_camera
    # self.red_team_selected_point = None

    # เพิ่มใน handle_canvas_click
    # ถ้าอยู่ในโหมดเลือก Red Team (เช่น self.selecting_red_team_point == True)
    # ให้บันทึก self.red_team_selected_point = (X_orig, Y_orig)
    # และเรียก self.red_team()
