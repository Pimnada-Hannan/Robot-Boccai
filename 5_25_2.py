...
class FieldMeasureApp:
    ...
    DEFAULT_DETECTION_PARAMS = {
        ...
        "colors": {
            "white": {
                "hsv_ranges": [(np.array([0, 0, 180]), np.array([180, 65, 255]))],
                "circularity": 0.65,
                "solidity": 0.75,
                "area_min": 100,
                "area_max": 1500,
    ...
    def __init__(self, root_tk):
        ...
        self.target_x_cm_str = StringVar(value="153.0")
        self.target_y_cm_str = StringVar(value="801.0")
        ...
        try:
            ...
            for i in indices_to_try:
                ...
                if temp_cap.isOpened():
                    self.cap = temp_cap
                    print(f"INFO: Cam @ index {i} (backend:{backend}) opened.")
                    break
                else:
                    temp_cap.release()
                                ...
                                if (
                                    ...
                                    if opponent_near_jack:  # 3
                                        ...
                                        if d130_value > 2:
                                            ...
                                            final_angle_deg = angle_for_eval
                                        else:
                                            if (
                                                self.current_team == self.TEAM_RED
                                            ):  # 3.1
                                                if (  # 3.1.1
                                                    dist_for_eval < 300
                                                    and final_angle_deg < 340
                                                    and final_angle_deg > 3
                                                ):
                                                    final_swing_speed = (
                                                        (dist_for_eval * 24.096)
                                                        + 5900
    ...
    def update_measurement_display(self, data_dict):
        if data_dict and isinstance(data_dict, dict):
            ...
            if dist_disp is not None:
                ...
                self.distance_display_str.set("Dist: Error")
