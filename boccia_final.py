...
class FieldMeasureApp:
    ...
    def open_hsv_popup(self):
        ...
        # Blue HSV Controls
        Label(hsv_popup, text="Blue Lower HSV:").pack(pady=5)
        ...
        self.blue_lower_v.pack(fill=X)

        Label(hsv_popup, text="Blue Upper HSV:").pack(pady=5)
        ...
        self.blue_upper_v.pack(fill=X)

        # Red HSV Controls
        Label(hsv_popup, text="Red Lower HSV:").pack(pady=5)
        ...
        self.red_lower_v.pack(fill=X)

        Label(hsv_popup, text="Red Upper HSV:").pack(pady=5)
                    ...
                    if perimeter > 0:
                        ...
                        if circularity > self.BALL_CIRCULARITY_THRESHOLD:
                            ...
                            if (
                                ...
                                confidence = min(
                                    1.0, (circularity * 0.7 + solidity * 0.7)
                                )
